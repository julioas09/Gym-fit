...
public class Consulta extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		message = intent.getStringExtra(Entrenamientos.EXTRA_MESSAGE);
		Toast.makeText(getApplicationContext(), "Selected: " + message, Toast.LENGTH_LONG).show();
		//Mensajes concretos de ese entrenamiento
